...
public class EmployeeActivity extends AppCompatActivity {
    ...
    private void saveToDB(String action) {
        ...
        if(action == "save"){
            ...
            long newRowId = database.update(SampleDBContract.Employee.TABLE_NAME, values,selection,selectionArgs);
            Toast.makeText(this, "Updated " + newRowId, Toast.LENGTH_LONG).show();
        }

    }

    private void readFromDB(String action) {
