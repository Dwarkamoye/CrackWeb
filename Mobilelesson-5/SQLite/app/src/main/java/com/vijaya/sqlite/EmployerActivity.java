...
public class EmployerActivity extends AppCompatActivity {
    ...
    private void actiononDB(String action) {
        ...
        try {
            ...
            Toast.makeText(this, "Error in date", Toast.LENGTH_LONG).show();
        }
        ...
        if(action == "read"){
            ...
            Toast.makeText(this, "Reading from database", Toast.LENGTH_LONG).show();
            binding.recycleView.setAdapter(new SampleRecyclerViewCursorAdapter(this, cursor));
        }
        else{
           database.delete(SampleDBContract.Employer.TABLE_NAME, selection,selectionArgs);
            Toast.makeText(this, "Deleted the record", Toast.LENGTH_LONG).show();
        }
    }
}