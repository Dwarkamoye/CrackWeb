...
public class HomeActivity extends AppCompatActivity {
    ...
    private void updateUI(){
        Toast.makeText(HomeActivity.this,"You are logged out",Toast.LENGTH_LONG).show();
        Intent goint = new Intent(HomeActivity.this,WelcomeActivity.class);
        startActivity(goint);
        finish();
    }
}