    ...
    var stopAudio = new Audio('audio/crash.mp3');
    ...
    function repeat() {
        if (collision(car, car_1) || collision(car, car_2) || collision(car, car_3) || collision(car, car_4)|| collision(car, car_5)|| collision(car, car_6)) {
            stop_the_game();
            if(!($("#leaderboard").data('bs.modal') || {})._isShown)
            {
                $('#restart-mod').modal('show');
            }
            return;
        }
        ...
        car_down(car_1);car_down(car_2);
        car_down(car_3);car_down(car_4);
        car_down(car_5);car_down(car_6);
    ...
    $(document).ready(function() {
        var userdata = JSON.parse(sessionStorage.getItem("race-user"));
        if (userdata) {
            user.text(userdata.email);
    ...
    function carstart(){
        $(startAudio).bind('ended', function()  {
